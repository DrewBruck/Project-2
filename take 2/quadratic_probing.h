...
class HashTable {
 public:
  ...
  size_t getTotalNumberOfElements() { return current_size_; }

  // getTotalSizeOfTable() assigns n to the size of the array
  size_t getTotalSizeOfTable() { return array_.size(); }

  //returns the number of collitions that occured during insert operation
 ...
 private:        
  ...
  mutable size_t collisions_count_ = 0;   //initialize counter for collisions
  ...
  void Rehash() {
    ...
    //Hash function to return new position after collision
